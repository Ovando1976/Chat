...
import { X, Home, Compass, MessageSquare, User, Menu, Sun, Moon } from "react-feather";
        ...
        <div className="flex flex-col flex-1 w-full">
          <header className="flex items-center justify-between w-full px-6 py-4 bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <button
              ...
              className="flex items-center justify-center w-10 h-10 text-gray-600 bg-gray-200 rounded-full hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
            >
